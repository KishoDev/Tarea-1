...
**
* Resumen:
* 	Si la raiz es NULL crea el nodo y asigna el tipoElem item al nodo->info; si no, llama a la 
*   función insertHelp. Al final nElems aumenta en uno (se le suma 1 a nElems).
**
* Input:
...
**
* Resumen:
*   Si el elemento tipoElem item es mayor al nodo, verifica si es NULL, si lo es crea el 
*   nodo derecho y a sus hijos, se le asigna el valor de tipoElem item, si no lo es, llama
*   a la función insertHelp, lo mismo pasa con el nodo izquierdo si el tipoElem es menor.
**
* Input:
*   - tNodoArbolBin* nodo; es un arreglo de struct en el que se almacena el nodo.
*   - tipoElem item; el elemento que se quiere agregar al ABB.
...
**
* Resumen: 
*   Busca al tipoElem item, para hacerlo llama a la función findHelp.
**
* Input:
...
**
* Resumen: 
*   Verifica si el nodo es NULL o si el tipoElem item e encontró (es igual al nodo) y si el 
*   nodo es mayor o menor al tipoElem item se llama a la función findHelp. 
**
* Input:
*   - tNodoArbolBin* nodo; es un arreglo de struct en el que se almacena el nodo.
*   - tipoElem item; el elemento que se quiere encontrar.
...
******
* Resumen:
* 	Busca el primer valor que sea menor o igual a item, se asegura de que la raiz exista antes
...
*	si se cumple que el valor sea menor o igual. Si no lo encuentra entonces avanzará al nodo
*	izquierdo y si no se encuentra un elemetno menor o igual al terminar el árbol, entonces 
*   retornará 0
******
* Input:
*   -tNodoArbolBin *nodo; es un arreglo de struct en el que se almacena el nodo
...
******
* Returns:
* 	Retorna un valor menor o igual a tipoElem item, y retorna 0, esto pasará solo si no se 
*   encuentra el elemento en el árbol.
*****/
